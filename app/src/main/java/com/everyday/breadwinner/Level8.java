...
public class Level8 extends AppCompatActivity implements View.OnTouchListener {
    ...
    private ImageView bread8, bread9, bread10, bread11;
    private ImageView rbread8, rbread9, rbread10, rbread11;
    ...
    public void launchBreadDialog() {
        ...
        newBread.setImageResource(R.drawable.bread_11);
...
//            rbread8.setY(rbread8Y);
            ...
            if (hitCheck(rbread9CenterX, rbread9CenterY)) {
                rbread9X = (float)Math.floor(Math.random() * (screenWidth - rbread9.getWidth() - 100.0f));
                rbread9Y = -500.0f;
                currentScore -= 500;
                scoreLabel.setText(String.valueOf(currentScore));
                checkNumOfStrawberries();
    ...
    public void endGame() {
        ...
        if (currentScore >= firstCut) {
            ...
            if (currentScore >= firstCut && currentScore < secondCut) {
                ...
                nextDay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level8.this, Level9.class);
                ...
                backToMenu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level8.this, ChooseLevelActivity.class);
                        startActivity(startDay);
                    }
                });
            ...
            editor.putInt("LEVEL_8_STATUS", 1);
            editor.apply();
        }
        else if (currentScore < firstCut){
            ...
            backToMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    finish();
                    soundPlayer.playButtonClicked();
                    Intent backMenu = new Intent(Level8.this, ChooseLevelActivity.class);
        ...
        if (currentStrawberries > earnedStrawberries) {
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_8_STRAWBERRIES", earnedStrawberries);
            editor.apply();
        }
        ...
        if (currentScore > highScore) {
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_8_HIGH_SCORE", highScore);
            editor.apply();
        }
    }
