...
public class Level17 extends AppCompatActivity implements View.OnTouchListener {
    ...
    private ImageView bread15, bread16, bread17, bread18, bread19, bread20, bread21;
    private ImageView rbread15, rbread16, rbread17, rbread18, rbread19, rbread20, rbread21;
    ...
    public void startGame() {
        ...
        bread20.setX((float)Math.floor(Math.random() * (screenWidth - bread20.getWidth())));
        bread21.setX((float)Math.floor(Math.random() * (screenWidth - bread21.getWidth())));
        ...
        rbread20.setX((float)Math.floor(Math.random() * (screenWidth - rbread20.getWidth())));
        rbread21.setX((float)Math.floor(Math.random() * (screenWidth - rbread21.getWidth())));
        ...
        newBread.setImageResource(R.drawable.bread_21);
...
//            rbread18.setY(rbread18Y);
            ...
            if (bread20.getY() > screenHeight) {
                bread20X = (float)Math.floor(Math.random() * (screenWidth - bread20.getWidth()));
                bread20Y = -500.0f;
                currentScore -= 525;
                scoreLabel.setText(String.valueOf(currentScore));
                checkNumOfStrawberries();
            ...
            if (rbread20.getY() > screenHeight) {
                rbread20X = (float)Math.floor(Math.random() * (screenWidth - rbread20.getWidth()));
                rbread20Y = -500.0f;
                scoreLabel.setText(String.valueOf(currentScore));
                checkNumOfStrawberries();
            }
            ...
            if (bread21.getY() > screenHeight) {
                bread21X = (float)Math.floor(Math.random() * (screenWidth - bread21.getWidth()));
                bread21Y = -500.0f;
                currentScore -= 550;
                scoreLabel.setText(String.valueOf(currentScore));
                checkNumOfStrawberries();
            ...
            if (rbread21.getY() > screenHeight) {
                rbread21X = (float)Math.floor(Math.random() * (screenWidth - rbread21.getWidth()));
                rbread21Y = -500.0f;
                scoreLabel.setText(String.valueOf(currentScore));
                checkNumOfStrawberries();
            }
    ...
    public void endGame() {
        ...
        if (currentScore >= firstCut && (!failedFlag)) {
            ...
            if (currentScore >= firstCut && currentScore < secondCut) {
                ...
                nextDay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level17.this, Level18.class);
                ...
                backToMenu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level17.this, ChooseLevelActivity.class);
                        startActivity(startDay);
                    }
                });
            ...
            if (currentStrawberries > earnedStrawberries) {
                ...
                editor.putInt("LEVEL_17_STRAWBERRIES", earnedStrawberries);
                editor.apply();
            }
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_17_STATUS", 1);
            editor.apply();
        }
            ...
            backToMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    finish();
                    soundPlayer.playButtonClicked();
                    Intent backMenu = new Intent(Level17.this, ChooseLevelActivity.class);
        ...
        if (currentScore > highScore) {
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_17_HIGH_SCORE", highScore);
            editor.apply();
        }
    }
