...
public class Level18 extends AppCompatActivity implements View.OnTouchListener {
    ...
    public void startGame() {
        ...
        bread22.setX((float)Math.floor(Math.random() * (screenWidth - bread22.getWidth())));
        ...
        rbread22.setX((float)Math.floor(Math.random() * (screenWidth - rbread22.getWidth())));
...
//            rbread19.setY(rbread19Y);
            ...
            if (bread22.getY() > screenHeight) {
                bread22X = (float)Math.floor(Math.random() * (screenWidth - bread22.getWidth()));
                bread22Y = -500.0f;
                currentScore -= 575;
                scoreLabel.setText(String.valueOf(currentScore));
                checkNumOfStrawberries();
            ...
            if (rbread22.getY() > screenHeight) {
                rbread22X = (float)Math.floor(Math.random() * (screenWidth - rbread22.getWidth()));
                rbread22Y = -500.0f;
                scoreLabel.setText(String.valueOf(currentScore));
                checkNumOfStrawberries();
            }
