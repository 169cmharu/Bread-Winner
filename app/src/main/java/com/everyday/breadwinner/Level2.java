...
public class Level2 extends AppCompatActivity implements View.OnTouchListener {
    ...
    private ImageView bread1, bread2, bread3, bread4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentDay.setText(R.string.d2);
        ...
        if (currentScore >= firstCut) {
            ...
            if (currentScore >= firstCut && currentScore < secondCut) {
                ...
                nextDay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level2.this, Level3.class);
                ...
                backToMenu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level2.this, ChooseLevelActivity.class);
                        startActivity(startDay);
                    }
                });
            ...
            backToMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    finish();
                    soundPlayer.playButtonClicked();
                    Intent backMenu = new Intent(Level2.this, ChooseLevelActivity.class);
