...
public class Level14 extends AppCompatActivity implements View.OnTouchListener {
    ...
    private ImageView bread15, bread16, bread17, bread18;
    private ImageView rbread15, rbread16, rbread17, rbread18;
    ...
    public void startGame() {
        ...
        newBread.setImageResource(R.drawable.bread_18);
...
//            rbread15.setY(rbread15Y);
    ...
    public void endGame() {
        ...
        if (currentScore >= firstCut && (!failedFlag)) {
            ...
            if (currentScore >= firstCut && currentScore < secondCut) {
                ...
                nextDay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level14.this, Level15.class);
                ...
                backToMenu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level14.this, ChooseLevelActivity.class);
                        startActivity(startDay);
                    }
                });
            ...
            editor.putInt("LEVEL_14_STATUS", 1);
            editor.apply();
        }
            ...
            backToMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    finish();
                    soundPlayer.playButtonClicked();
                    Intent backMenu = new Intent(Level14.this, ChooseLevelActivity.class);
        ...
        if (currentStrawberries > earnedStrawberries) {
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_14_STRAWBERRIES", earnedStrawberries);
            editor.apply();
        }
        ...
        if (currentScore > highScore) {
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_14_HIGH_SCORE", highScore);
            editor.apply();
        }
    }
