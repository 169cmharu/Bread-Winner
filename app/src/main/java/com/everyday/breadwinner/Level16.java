...
public class Level16 extends AppCompatActivity implements View.OnTouchListener {
    ...
    private ImageView bread15, bread16, bread17, bread18, bread19, bread20;
    private ImageView rbread15, rbread16, rbread17, rbread18, rbread19, rbread20;
    ...
    public void startGame() {
        ...
        newBread.setImageResource(R.drawable.bread_20);
    ...
    public void endGame() {
        ...
        if (currentScore >= firstCut && (!failedFlag)) {
            ...
            if (currentScore >= firstCut && currentScore < secondCut) {
                ...
                nextDay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level16.this, Level17.class);
                ...
                backToMenu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level16.this, ChooseLevelActivity.class);
                        startActivity(startDay);
                    }
                });
            ...
            if (currentStrawberries > earnedStrawberries) {
                ...
                editor.putInt("LEVEL_16_STRAWBERRIES", earnedStrawberries);
                editor.apply();
            }
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_16_STATUS", 1);
            editor.apply();
        }
            ...
            backToMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    finish();
                    soundPlayer.playButtonClicked();
                    Intent backMenu = new Intent(Level16.this, ChooseLevelActivity.class);
        ...
        if (currentScore > highScore) {
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_16_HIGH_SCORE", highScore);
            editor.apply();
        }
    }
