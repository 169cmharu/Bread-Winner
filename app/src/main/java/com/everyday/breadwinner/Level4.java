...
public class Level4 extends AppCompatActivity implements View.OnTouchListener {
    ...
    private ImageView bread1, bread2, bread3, bread4, bread5, bread6;
    ...
    public void launchBreadDialog() {
        ...
        newBread.setImageResource(R.drawable.bread_6);
    ...
    public void endGame() {
        ...
        if (currentScore >= firstCut) {
            ...
            if (currentScore >= firstCut && currentScore < secondCut) {
                ...
                nextDay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level4.this, Level5.class);
                ...
                backToMenu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level4.this, ChooseLevelActivity.class);
                        startActivity(startDay);
                    }
                });
            ...
            editor.putInt("LEVEL_4_STATUS", 1);
            editor.apply();
        }
        else if (currentScore < firstCut){
            ...
            backToMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    finish();
                    soundPlayer.playButtonClicked();
                    Intent backMenu = new Intent(Level4.this, ChooseLevelActivity.class);
        ...
        if (currentStrawberries > earnedStrawberries) {
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_4_STRAWBERRIES", earnedStrawberries);
            editor.apply();
        }
        ...
        if (currentScore > highScore) {
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_4_HIGH_SCORE", highScore);
            editor.apply();
        }
    }
