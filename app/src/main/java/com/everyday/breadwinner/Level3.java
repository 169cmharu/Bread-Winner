...
public class Level3 extends AppCompatActivity implements View.OnTouchListener {
    ...
    private ImageView bread1, bread2, bread3, bread4, bread5;
    ...
    public void startGame() {
        ...
        newBread.setImageResource(R.drawable.bread_5);
    ...
    public void endGame() {
        ...
        if (currentScore >= firstCut) {
            ...
            if (currentScore >= firstCut && currentScore < secondCut) {
                ...
                nextDay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level3.this, Level4.class);
                ...
                backToMenu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level3.this, ChooseLevelActivity.class);
                        startActivity(startDay);
                    }
                });
            ...
            if (currentStrawberries > earnedStrawberries) {
                ...
                editor.putInt("LEVEL_3_STRAWBERRIES", earnedStrawberries);
                editor.apply();
            }
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_3_STATUS", 1);
            editor.apply();
        }
        else if (currentScore < firstCut){
            ...
            backToMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    finish();
                    soundPlayer.playButtonClicked();
                    Intent backMenu = new Intent(Level3.this, ChooseLevelActivity.class);
        ...
        if (currentScore > highScore) {
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_3_HIGH_SCORE", highScore);
            editor.apply();
        }
    }
