...
public class Level10 extends AppCompatActivity implements View.OnTouchListener {
    ...
    private ImageView bread8, bread9, bread10, bread11, bread12, bread13;
    private ImageView rbread8, rbread9, rbread10, rbread11, rbread12, rbread13;
    ...
    public void startGame() {
        ...
        newBread.setImageResource(R.drawable.bread_13);
    ...
    public void endGame() {
        ...
        if (currentScore >= firstCut) {
            ...
            if (currentScore >= firstCut && currentScore < secondCut) {
                ...
                nextDay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level10.this, Level11.class);
                ...
                backToMenu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        soundPlayer.playButtonClicked();
                        finish();
                        Intent startDay = new Intent(Level10.this, ChooseLevelActivity.class);
                        startActivity(startDay);
                    }
                });
            ...
            if (currentStrawberries > earnedStrawberries) {
                ...
                editor.putInt("LEVEL_10_STRAWBERRIES", earnedStrawberries);
                editor.apply();
            }
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_10_STATUS", 1);
            editor.apply();
        }
        else if (currentScore < firstCut){
            ...
            backToMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    finish();
                    soundPlayer.playButtonClicked();
                    Intent backMenu = new Intent(Level10.this, ChooseLevelActivity.class);
        ...
        if (currentScore > highScore) {
            ...
            SharedPreferences.Editor editor = dataLevel.edit();
            editor.putInt("LEVEL_10_HIGH_SCORE", highScore);
            editor.apply();
        }
    }
